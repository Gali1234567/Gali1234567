// ejercicio 4 OrdenarArreglos.java
/******************************************************************************

 ¿Cómo ordenar un arreglo y encontrar un elemento demtro de este ?
*******************************************************************************/
...
public static void imprimirArreglo(String mensaje , int arreglo[]){
 ...
 System.out.println();
	...
	float mifloteante = 1.0f;
	double[][] matriz = new double [3][3];
	Arrays.sort(ejemplo_arreglo);
	//Se imprime el Arreglo ordenado por método sort de Arrays de la clase Utils de java
	imprimirArreglo("Arreglo Ordenado",ejemplo_arreglo);
	//Se busca el indice del valor -2 ,por el metodo binarySearch de la clase de arrays 
